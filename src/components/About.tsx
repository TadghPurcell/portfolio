...
export default function About() {
  ...
  return (
    ...
    >
        ...
        <span className="italic">November 2022</span> with web development through {" "} 
        ...
        <span className="font-semibold">Tailwind CSS</span> on the front end, 
        ...
        making an application work together. 
        </p>

        <p className='mb-3'>
        Outside of work, I stay active by running and training for the Barcelona Marathon, going to the gym, 
        and practicing Brazilian Jiu-Jitsu. I also enjoy attending gigs, climbing mountains, going to the beach, 
